 ...
 return React.createElement('div',{className:'auth-screen'},
  React.createElement('div',{className:'auth-card'},
   ...
   mode === 'login' && React.createElement(React.Fragment,null,
    React.createElement('button',{type:'button',className:'auth-google',onClick:signInGoogle,disabled:busy},React.createElement('span',{className:'google-mark'},'G'),'Continuar com Google'),
...
function PasswordRecoveryScreen({ onDone }) {
 ...
 return React.createElement('div',{className:'auth-screen'},React.createElement('div',{className:'auth-card'},
  React.createElement('div',{className:'auth-brand'},React.createElement('div',{className:'auth-logo'},'S'),React.createElement('div',null,React.createElement('div',{className:'auth-title'},'Synapse'),React.createElement('div',{className:'auth-subtitle'},'Gestão comercial e mentalidade'))),
